...
test types are all sub-classes of {TestPlan}. The list of test plan typess is
...
{Kind}:: test type enumeration (e.g. XDS P&R, C32 D&F) *DEPRECATED*
{TestResult}:: pass/fail info and PIX/PDQ-specific result data *DEPRECATED*
...
{VendorTestPlansController}:: manage test plans *DEPRECATED*
{TestopController}:: test-specific actions *DEPRECATED*

=== Library Code

{TestType}:: Callback-based test type specification *DEPRECATED*
