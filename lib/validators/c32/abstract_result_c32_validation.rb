# section_template_id() must be overwritten by the class/module including this AbstractResult
# validator
module AbstractResultValidation

  include MatchHelper

  # Must be overwritten, or will raise a runtime error.
  def section_template_id
    raise(RuntimeError, "AbsctractResultValidation#section_template_id must be overwritten with a validcode for the concrete result subtype.")
  end

  # Reimplementing from MatchHelper
  def section_name
    "#{self.class.name.pluralize.titleize} Module"
  end
