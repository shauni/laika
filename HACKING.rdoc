...
If you want to be able to use the ruby-debug command line debugger, you will need
to install a base gem which has the native extensions compiled, because JRuby 
